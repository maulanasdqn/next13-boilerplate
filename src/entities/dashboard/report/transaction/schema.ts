...
export const VSReportTransaction = z.object({
  ...
  user_id: z.string({ required_error: "Pengguna harus diisi" }),
  ...
  transaction_date: z.date({ required_error: "Waktu transaksi harus diisi" }),
  transaction_time: z.string({ required_error: "Waktu transaksi harus diisi" }),
  total_selled: z.number({ required_error: "Total terjual harus diisi" }),
  total_price: z.number({ required_error: "Total harga harus diisi" }),
});
