...
export const AreaChartAdmin: FC = (): ReactElement => {
  const chartRef = useRef();
  const [chartType, setChartType] = useState<string>("mingguan");
      ...
      <div className="w-full rounded-lg bg-white p-4 my-2 h-fit shadow-sm">
        <div className="flex items-center justify-between">
          <div className="flex gap-x-2 items-center">
            <h1 className="text-xl font-semibold ">User Transaksi Terbanyak</h1>
            <span>
              <PiChartBarFill size={30} className="text-[#296253]" />
            </span>
          </div>
          <div>
            <Select
